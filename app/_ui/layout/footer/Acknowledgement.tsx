...
const Acknowledgement = ({ lightHeader = false }: { lightHeader: boolean }) => {
  return (
    <section
    ...
    >
      <div className="relative overflow-hidden rounded-lg border border-black/10 bg-org-secondary-dark p-4 sm:p-5">
        ...
        <FooterHeader lightContent={lightHeader}>Acknowledgements</FooterHeader>

        {/* Country Acknowledgement */}
        <P className="  text-gray-100" size="sm">
        ...
        <P className=" text-gray-100 mt-3" size="sm">
